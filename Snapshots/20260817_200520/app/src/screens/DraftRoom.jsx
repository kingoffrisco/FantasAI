...
export default function DraftRoom({ aiMode, user, onNav, onDraftPick, onDraftComplete, onDraftStatusChange, onOpenPlayer }) {
  ...
  const [mobileDraftTab, setMobileDraftTab] = React.useState('board'); // 'board' | 'panel'
  ...
  return (
    ...
    >
      ...
      <div className="draft-roster" style={isMobile && mobileDraftTab !== 'panel' ? { display: 'none' } : { display: 'flex', flexDirection: 'column' }}>
        {/* Tab strip */}
        ...
        {rosterPanelView === 'ghosts' && (
          <div style={{ display: 'flex', flexDirection: 'column', flex: 1, overflow: 'hidden' }}>
            ...
            <div className="ghost-strip" style={{ padding: '6px 12px 10px' }}>
            ...
            <div style={{ flex: 1, overflow: 'auto', padding: '8px 0' }}>
              <div style={{ padding: '6px 12px 8px', borderBottom: '1px solid var(--border)', marginBottom: 8 }}>
                <div style={{ display: 'flex', alignItems: 'center', marginBottom: 6 }}>
                  <div className="card-title" style={{ flex: 1, fontSize: 12 }}>Draft Activity</div>
                ...
                {(() => {
                  ...
                  return rows.slice(0, 28).map(row => {
                    if (row.kind === 'event') {

...
export const api = {
  ...
  r2: {
    ...
    olineIndexWeekly:   () => r2Get('fantasai/analysis/oline_index_weekly.json'),
    olineRookieScores:  () => r2Get('fantasai/analysis/oline_rookie_scores.json'),
    ...
    playerCoverageSplits: () => r2Get('fantasai/analysis/player_coverage_splits.json'),
    teamCoverageTendency: () => r2Get('fantasai/analysis/team_coverage_tendency.json'),
    playerRushBoxSplits:  () => r2Get('fantasai/analysis/player_rush_box_splits.json'),
    teamRushBoxTendency:  () => r2Get('fantasai/analysis/team_rush_box_tendency.json'),
